<template>
  <section>
    <rg-heading-content
      title="Sebuah refleksi dua tahun di Bukalapak"
      sub-title="20 Januari 2020" />
    ...
    <div class="container mx-auto xl:pb-24 pb-12 xl:px-64 md:px-24 px-4">
      <article class="xl:pb-12 pb-6 prose xl:prose-xl sm:prose-sm md:prose-lg" style="max-width: none;">
        <figure>
          <img src="~/static/images/blog_thumbnails/sebuah-refleksi-dua-tahun-di-bukalapak.webp" alt="Photo from Unplash">
          <figcaption>Onboarding pertama</figcaption>
        </figure>
        <p>
        ...
        <h2>Gotong royong</h2>
        <figure>
          <img src="~/static/images/blog_contains/sebuah-refleksi-dua-tahun-di-bukalapak-1.webp" alt="Photo from Unplash">
        </figure>
        <p>
          Lima bulan dari saya join, Bukalapak mengadakan hackathon untuk internal karyawannya. Tidak hanya product engineer, tapi seluruh karyawan dari berbagai divisi diperbolehkan untuk ikut. Untuk pertama kalinya, Bukalapak tidak hanya mengadakan hackathon, tapi juga testathon dan designathon. Ketiga acara tersebut diberi nama <b>Hack-a-Fun</b>.
        </p>
        <p>
        ...
        <figure>
          <img src="~/static/images/blog_contains/sebuah-refleksi-dua-tahun-di-bukalapak-2.webp" alt="Aplikasi bot telegram yang saya buat ketika Hack-a-Fun">
        </figure>
        <h2>Speak up!</h2>
        <p>
        ...
        <figure>
          <img src="~/static/images/blog_contains/sebuah-refleksi-dua-tahun-di-bukalapak-3.webp" alt="Saya beserta FE lain yang memperkenalkan diri">
          <figcaption>Saya beserta FE lain yang memperkenalkan diri</figcaption>
        </figure>
        <p>
        ...
        <ul>
          <li>
            <b>Sprint</b> merupakan jantung dari scrum. Di Bukalapak, waktu yang digunakan untuk satu sprint adalah dua minggu.
          </li>
          <li>
            Tiap awal sprint, kami melakukan <b>sprint planning</b>. Tujuannya untuk merencanakan task atau story yang akan kami kerjakan di sprint tersebut.
          </li>
          <li>
            Di tiap sprint, kami menentukan <b>sprint goal</b> yang idealnya harus tercapai di sprint tersebut.
          </li>
          <li>
            Di tiap sprint, kami menentukan <b>sprint goal</b> yang idealnya harus tercapai di sprint tersebut.
          </li>
          <li>
            Di sepanjang sprint, kami melakukan <b>daily standup</b> meeting kurang lebih 15 menit. Meeting ini bertujuan untuk mereview task atau story yang ada di sprint tersebut.
          </li>
          <li>
            Di akhir sprint, kami melakukan <b>retrospective</b>, <b>sprint review</b>, dan <b>marketplace</b>.
          </li>
          <li>
            Pada sesi <b>retrospective</b>, kami meninjau performa sprint yang sudah kita lalui sebelumnya. Dari sesi ini diharapkan dapat meningkatkan performa sprint berikutnya.
          </li>
        </ul>
        <h2>Try, Fail, and Try Again</h2>
        <p>
        ...
        <figure>
          <img src="~/static/images/blog_contains/sebuah-refleksi-dua-tahun-di-bukalapak-5.webp" alt="Saya bersama beberapa rekan kantor">
        </figure>
        <p>
          <i>Best perks</i> yang dibangun oleh Bukalapak itu bukan free lunch setiap hari, flexible work hour, entertainment budget, atau bahkan gaji tinggi.
        </p>
        <p>
      ...
      <rg-label label="bukalapak engineering"/>
      <rg-label label="culture"/>
      <rg-label label="career"/>
      <rg-label label="scrum"/>
    </div>
  </section>
</template>
...
export default {
  head: {
    title: 'Sebuah refleksi dua tahun di Bukalapak | Rizal Asrul Pambudi',
    meta: [
      {
        name: 'keywords',
        content: 'bukalapak, bukalapak engineering, culture, career, scrum, rizal, asrul, pambudi',
      },
      {
        hid: 'description',
        name: 'description',
