<template>
  <section>
    <rg-heading-content
      title="Yang patut disyukuri di 2019"
      sub-title="30 Desember 2019" />
    ...
    <div class="container mx-auto xl:pb-24 pb-12 xl:px-64 md:px-24 px-4">
      <article
        ...
        <blockquote>
          <p>Everyone is fighting their own battles that you probably do not know about.</p>
        </blockquote>
        <p>
        ...
        <h2>Mentoring adik-adik mahasiswa di kampus</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-1.webp"
            alt="Berbagi tentang dunia UI/UX di industri">
          <figcaption>Berbagi tentang dunia UI/UX di industri</figcaption>
        </figure>
        <h2>Menikah</h2>
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-2.webp"
            alt="Foto di depan pintu Masjid Al Akbar Surabaya.">
          <figcaption>Foto di depan pintu Masjid Al Akbar Surabaya.</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-3.webp"
            alt="Foto bareng teman-teman kuliah">
          <figcaption>Foto bareng teman-teman kuliah</figcaption>
        </figure>
        <h2>Jalan-jalan ke Bandung</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-4.webp"
            alt="Tidak hanya tempat makan, Punclut juga ada titik-titik foto yang menarik">
          <figcaption>Tidak hanya tempat makan, Punclut juga ada titik-titik foto yang menarik</figcaption>
        </figure>
        <p>
        ...
        <h2>Jalan-jalan ke Jakarta Aquarium</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-5.webp"
            alt="Coba tebak gimana caranya masuk ke aquarium itu?">
          <figcaption>Coba tebak gimana caranya masuk ke aquarium itu?</figcaption>
        </figure>
        <p>
          Yang paling seru adalah mermaid show yang sangat menarik, apalagi pertunjukannya di dalam air aquariumnya.
        </p>
        <h2>Jalan-jalan ke Malang</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-6.webp"
            alt="Lebaran pertama bareng istri">
          <figcaption>Lebaran pertama bareng istri</figcaption>
        </figure>
        <h2>Lebaran sekeluarga di Blitar</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-7.webp"
            alt="Foto di salah satu titik BFG">
          <figcaption>Foto di salah satu titik BFG</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-8.webp"
            alt="Team building bareng keluarga Blitar">
          <figcaption>Team building bareng keluarga Blitar</figcaption>
        </figure>
        <h2>Outing ke Jogja</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-9.webp"
            alt="Foto bareng anggota tim ketika outing">
          <figcaption>Foto bareng anggota tim ketika outing</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-10.webp"
            alt="Arung jeram nggak bikin keram">
          <figcaption>Arung jeram nggak bikin keram</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-11.webp"
            alt="Foto bareng teman-teman squad">
          <figcaption>Foto bareng teman-teman squad</figcaption>
        </figure>
        <h2>Jalan-jalan ke Banyuwangi</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-12.webp"
            alt="Melihat hamparan tanah di Baluran">
          <figcaption>Melihat hamparan tanah di Baluran</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-13.webp"
            alt="Snorkling di laut Pulau Menjangan">
          <figcaption>Snorkling di laut Pulau Menjangan</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-14.webp"
            alt="Foto di puncak Gunung Ijen">
          <figcaption>Foto di puncak Gunung Ijen</figcaption>
        </figure>
        <h2>Staycation di Lembang</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-15.webp"
            alt="Staycation bareng tim">
          <figcaption>Staycation bareng tim</figcaption>
        </figure>
        <h2>Dua tahun di Bukalapak</h2>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_thumbnails/yang-patut-disyukuri-di-2019.webp"
            alt="Foto bareng beberapa teman divisi">
          <figcaption>Foto bareng beberapa teman divisi</figcaption>
        </figure>
        <p>
        ...
        <figure>
          <img
            src="~/static/images/blog_contains/yang-patut-disyukuri-di-2019-16.webp"
            alt="Foto bareng Bukalapak Surabaya Squad saat lomba tujuh belasan">
          <figcaption>Foto bareng Bukalapak Surabaya Squad saat lomba tujuh belasan</figcaption>
        </figure>
        <p>
      ...
      <rg-label label="resolusi"/>
      <rg-label label="tahun baru"/>
      <rg-label label="2019"/>
      <rg-label label="bukalapak"/>
      <rg-label label="bersyukur"/>
    </div>
  </section>
</template>
...
export default {
  head: {
    title: 'Yang patut disyukuri di 2019 | Rizal Asrul Pambudi',
    meta: [
      {
        name: 'keywords',
        content: 'resolusi, tahun baru, 2019, bukalapak, bersyukur, rizal, asrul, pambudi',
      },
      {
        hid: 'description',
        name: 'description',
