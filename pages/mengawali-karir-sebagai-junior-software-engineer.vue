  ...
  <section style="background-color: #1a1a2e;">
    ...
    <div class="container mx-auto xl:pb-24 pb-12 xl:px-64 md:px-24 px-4">
      <article class="xl:pb-12 pb-6 prose xl:prose-xl sm:prose-sm md:prose-lg" style="max-width: none;">
        ...
        <ul>
          <li>Daily standup (termasuk jika kita sedang remote)</li>
          <li>Marketplace</li>
        ...
        <blockquote>
          <p>Everybody makes mistakes. The difference is based on how they respond to the mistake.</p>
        </blockquote>
        <p>
        ...
        <figure>
          <img src="~/static/images/blog_contains/mengawali-karir-sebagai-junior-software-engineer-2.webp" alt="Photo from Unplash">
          <figcaption>Pair programming adalah cara yang efektif untuk saling tukar wawasan</figcaption>
        </figure>
        <p>
      ...
      <rg-label label="junior"/>
      <rg-label label="programming"/>
...
export default {
  head: {
    title: 'Mengawali karir sebagai junior software engineer | Rizal Asrul Pambudi',
    meta: [
      {
        name: 'keywords',
        content: 'junior, programming, software engineer, career, scrum, rizal, asrul, pambudi',
      },
      {
        hid: 'description',
        name: 'description',
