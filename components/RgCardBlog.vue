<template>
  <nuxt-link
    :to="slug"
    class="w-full lg:w-4/12 px-4 xl:mb-24 md:12 mb-8"
    style="text-decoration: none;">
    <div
      class="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full xl:mb-6 mb-4 shadow-lg rounded-lg"
